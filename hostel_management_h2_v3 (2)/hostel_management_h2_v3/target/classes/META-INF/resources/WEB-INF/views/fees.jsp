...
<body><div class="container">
  <div class="card">
    ...
    <form action="/fees/add" method="post">
    ...
    <table>
      <tr><th>Student</th><th>Amount</th><th>Status</th><th>Last Updated</th></tr>
      <c:forEach var="p" items="${payments}">
        <tr>
          <td>${p.studentId}</td><td>${p.amount}</td><td>${p.status}</td><td>${p.date}</td>
        </tr>
      </c:forEach>
    </table>
  </div>
