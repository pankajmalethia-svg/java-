...
<body><div class="container">
  <div class="card">
    ...
    <table>
      <tr><th>ID</th><th>Student</th><th>Category</th><th>Description</th><th>Status</th></tr>
      <c:forEach var="citem" items="${complaints}">
        <tr>
          <td>${citem.id}</td><td>${citem.studentId}</td><td>${citem.category}</td><td>${citem.description}</td><td>${citem.status}</td>
        </tr>
      </c:forEach>
    </table>
  </div>
